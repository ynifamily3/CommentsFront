...
var naver_id_login = function (client_id, redirect_uri) {
  ...
  this.setState = function (state_value) {
    this.state =
      typeof state_value != "undefined" && state_value != "" ? state_value : "";
  };
  /**
   * 서비스 도메인 설정
   * @ignore
  ...
  this.setDomain = function (domain_value) {
    this.nil_domain =
      typeof domain_value != "undefined" && domain_value != ""
        ? domain_value
        : "";
  };
  /**
  ...
  this.setButton = function (button_color, button_type, button_height) {
    this.button_color =
      typeof button_color != "undefined" && button_color != ""
        ? button_color
        : BUTTON_COLOR_GREEN;
    this.button_type =
      typeof button_type != "undefined" && button_type != ""
        ? button_type
        : BUTTON_TYPE;
    this.button_height =
      typeof button_height != "undefined" && button_height != ""
        ? button_height
        : 40;
  };
  /**
  ...
  this.setStateStore = function () {
    try {
      if (this.nil_domain != "") {
        ...
        document.cookie =
          this.cookie_name + "=; path=/; expires=Thu, 01 Jan 1970 00:00:00 UTC";
      }
  ...
  this.getNaverIdLoginLink = function () {
    ...
    if (
      ...
      this.client_id == "등록한 ClientID 값" ||
      this.client_id.length < 5
    ) {
    ...
    if (
      ...
      this.redirect_uri == "등록한 Callback URL 값" ||
      this.redirect_uri.length < 5
    ) {
